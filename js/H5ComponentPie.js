...
var H5ComponentPie = function ( name, cfg ) {
    ...
    var colors = ['red', '#ccc', '#faa', 'orange','pink']; //备用颜色
...
H5ComponentPie.reSort = function ( list ) {
    ...
    var compare = function ( domA, domB ) {
       ...
       /* // 检测 x
        var instersect_x = (shadowA_x[0] > shadowB_x[0] && shadowA_x[0] < shadowB_x[1])
                || (shadowA_x[1] > shadowB_x[0] && shadowA_x[1] < shadowB_x[1]);

        //检测 y
        var instersect_y = (shadowA_y[0] > shadowB_y[0] && shadowA_y[0] < shadowB_y[1])
